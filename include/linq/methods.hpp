...
namespace linq
{
	namespace v2
	{
		...
		class decorate : public Base // , public user_hooks<Derived, Base, void>
		{
		public:
			...
			public:
				...
				iterator(const decorate *e) : e(e->move_first() ? e : nullptr)
				{
				}
			...
			public:
				...
				reverse_iterator(const decorate *e) : e(e->move_last() ? e : nullptr)
				{
				}
