...
namespace linq
{
	...
	class skip_t : public v2::decorate<skip_t<Enumerable>, v2::ienumerable<typename Enumerable::value_type>>
	{
	public:
	...
	template<typename Enumerable>
	class limit_t : public v2::decorate<limit_t<Enumerable>, v2::ienumerable<typename Enumerable::value_type>>
	{
	public:
		typedef typename Enumerable::value_type value_type;
